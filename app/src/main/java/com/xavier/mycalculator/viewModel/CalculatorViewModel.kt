package com.xavier.mycalculator.viewModel
...
class CalculatorViewModel:ViewModel() {
    ...
    fun onAction(action: CalculatorAction){
        when(action){
            ...
            is CalculatorAction.ClearAll -> state = CalculatorState()
            is CalculatorAction.Operations -> enterOperations(action.calculatorOperation)
    ...
    private fun enterOperations(calculatorOperation: CalculatorOperation) {
